...
- Claim limit: this is method/spec guidance for building connectors. It does not by itself prove
  any deployed bridge, package parity, production readiness, or public release. ValuAziende and
  the other benches are sanitized case studies, not the model the skill targets.
